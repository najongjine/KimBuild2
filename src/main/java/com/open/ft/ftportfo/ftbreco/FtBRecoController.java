package com.open.ft.ftportfo.ftbreco;
 ...
 */
@Controller
public class FtBRecoController {
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "BExam";

    /** folderPath **/
    private final static String folderPath = "/ft/ftportfo/ftbexam/";
