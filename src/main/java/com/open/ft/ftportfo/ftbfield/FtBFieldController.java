package com.open.ft.ftportfo.ftbfield;
 ...
 */
@Controller
public class FtBFieldController {
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "BField";

    /** folderPath **/
    private final static String folderPath = "/ft/ftportfo/ftbfield/";
