package com.open.ft.ftportfo.ftbexam;
 ...
 */
@Controller
public class FtBExamController {
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "BReco";

    /** folderPath **/
    private final static String folderPath = "/ft/ftportfo/ftbreco/";
