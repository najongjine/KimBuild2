package com.open.ft.ftportfo.ftinteexam;
 ...
 */
@Controller
public class FtInteExamController {
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "InteExam";

    /** folderPath **/
    private final static String folderPath = "/ft/ftportfo/ftinteexam/";
	...
	public String addList(@ModelAttribute("searchVO") CmmnDefaultVO searchVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		List<BImgVO> resultList = (List<BImgVO>) cmmnService.selectList(searchVO, PROGRAM_ID );
	...
	public String view(@ModelAttribute("searchVO") BImgVO searchVO, Model model, HttpServletRequest request) throws Exception {
		
		/* 게시판 상세정보 */
		BImgVO boardVO = new BImgVO();
		boardVO = (BImgVO) cmmnService.selectContents(searchVO, PROGRAM_ID );
		List<ImgVO> imgList=(List<ImgVO>) cmmnService.selectList(boardVO, PROGRAM_ID+".selectImgList");
	...
	public String form(@ModelAttribute("searchVO") BImgVO searchVO, Model model,@PathVariable String procType, HttpServletRequest request) throws Exception {
	...
	public String proc(@ModelAttribute("searchVO") BImgVO searchVO, Model model, SessionStatus status,@PathVariable String procType, HttpServletRequest request) throws Exception {
