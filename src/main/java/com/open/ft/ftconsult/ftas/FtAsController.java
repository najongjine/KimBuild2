package com.open.ft.ftconsult.ftas;
...
public class FtAsController {
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "As";

    /** folderPath **/
    private final static String folderPath = "/ft/ftconsult/ftas/";
